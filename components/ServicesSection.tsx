      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {activeData.cards.map((card, idx) => (
            ...
            >
              {card.tag && (
                <div className="absolute -top-3 right-6 bg-gradient-to-r from-emerald-600 to-teal-600 text-white text-xs font-bold px-3 py-1 rounded-full shadow-md uppercase tracking-wider">
                  {card.tag}
                </div>
              )}
              ...
              <div>
                ...
                <div className="my-5 pb-4 border-b border-slate-100 flex items-baseline justify-between">
                  ...
                  <div className="flex items-center gap-1 text-xs text-slate-500 bg-slate-100 px-2.5 py-0.5 rounded-md">
