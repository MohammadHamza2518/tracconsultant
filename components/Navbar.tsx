      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-2 xl:gap-4">
          ...
          <Link href="/" className="flex items-center gap-2.5 sm:gap-3 group shrink-0">
            <div className="relative w-10 h-10 sm:w-11 sm:h-11 xl:w-12 xl:h-12 flex-shrink-0 group-hover:scale-105 transition-transform">
              <Image 
                src="/logo.png" 
                alt="Tracconsultant" 
                fill 
          ...
          <div className="hidden lg:flex items-center gap-2 xl:gap-3.5 shrink-0">
                ...
                <div className="absolute top-full left-1/2 -translate-x-1/4 xl:-translate-x-1/5 mt-2 w-[980px] max-w-[calc(100vw-2rem)] bg-white rounded-3xl shadow-2xl border border-slate-200 p-6 animate-in fade-in slide-in-from-top-2 duration-150 z-50">
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs bg-slate-50/90 -mx-6 -mb-6 p-4 rounded-b-3xl">
                    <div className="flex items-center gap-2 text-slate-600">
                      ...
                      <span className="font-semibold text-slate-700">All 20 Services Handled by Senior In-House CAs</span>
                    ...
                    >
                      <span>Explore Full 20 Services Directory & Document Guides</span>
            ...
            {user && (
              <Link
                href="/dashboard"
                className={`px-2.5 xl:px-3 py-2 rounded-xl text-xs xl:text-sm font-semibold whitespace-nowrap shrink-0 transition-colors flex items-center gap-1.5 shadow-xs ${
                  pathname === '/dashboard'
            ...
            {isLoading ? (
              ...
              <div className="relative shrink-0" ref={userMenuRef}>
                <button
                  ...
                  className="flex items-center gap-2.5 p-1.5 pr-3 rounded-full border border-slate-200 hover:border-slate-300 hover:shadow-sm bg-slate-50/70 whitespace-nowrap shrink-0 transition-all cursor-pointer"
                >
                  {user.avatar ? (
                    <img src={user.avatar} alt={user.name} className="w-8 h-8 rounded-full object-cover border border-emerald-500 shrink-0" />
                  ) : (
