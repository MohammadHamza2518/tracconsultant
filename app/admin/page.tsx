          ...
          <div className="w-full max-w-2xl bg-white rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 max-h-[92vh] overflow-y-auto">
            ...
            <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200/80 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div>
                  <span className="text-slate-400 text-[10px] block font-semibold uppercase">Customer Name</span>
                  <span className="font-bold text-slate-900 text-sm">{selectedFiling.fullName}</span>
                </div>
