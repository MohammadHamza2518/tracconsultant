...
export const TOOLS_LIST: ToolConfig[] = [
  ...
  {
    id: 'tax-calculator',
    name: 'Income Tax Computation Tool (FY 23-24, 24-25 & 25-26)',
    slug: 'tax-calculator',
    category: 'free',
    price: 0,
    badge: 'Budget Updated',
    shortDesc: 'Side-by-side comparison of Old vs New Tax Regime for FY 23-24, 24-25 & 25-26 with ₹75,000 std deduction.',
